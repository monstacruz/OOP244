...
namespace sict {
	...
	void answers(const int* year, const int* population, const int* violentCrime,
        ...
        cout << "Population change from " << year[0] << " to " << year[n-1] << " is " << setprecision(2) << fixed << static_cast<double>(popChange)/1000000 << " million" << endl;


		// Q2. print whether violent crime rate has gone up or down between 2000 and 2005
        cout << "Violent Crime trend is " << (violentCrimeRate[0] > violentCrimeRate[n-1] ? "down" : "up") << endl;
